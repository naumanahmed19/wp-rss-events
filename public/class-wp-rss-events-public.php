 ...
 * @subpackage Wp_Rss_Events/public
 */
...
class Wp_Rss_Events_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wp-rss-events-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp-rss-events-public.js', array( 'jquery' ), $this->version, false );
