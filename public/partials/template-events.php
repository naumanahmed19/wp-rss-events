                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
                      <header class="entry-header has-text-align-center">
                        <div class="entry-header-inner section-inner medium">
                            <h2 class="entry-title heading-size-1"><a href="<?php the_permalink();?>"><?php the_title(); ?></a></h2>
                          <div class="post-meta-wrapper post-meta-single post-meta-single-top">
                            <ul class="post-meta">
                                  ...
                                  <span class="meta-text">
                                    By <a href="http://localhost:8000/?author=1">admin</a>						</span>
                                </li>
                                  ...
                                  <span class="meta-text">
                                    <a href="http://localhost:8000/?p=1">April 14, 2021</a>
                                  </span>
                                </li>
                                  ...
                                  <span class="meta-text">
                                    <a href="http://localhost:8000/?p=1#comments">1 Comment<span class="screen-reader-text"> on Hello world!</span></a>						</span>
                                </li>
